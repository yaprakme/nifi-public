...
@CapabilityDescription("Provides the ability to create Pulsar Producer / Consumer instances on demand, "
        + "based on the configuration properties defined. More detail about java client library and its properties check out http://pulsar.apache.org/docs/en/client-libraries-java/ ")

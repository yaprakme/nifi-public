...
public class PulsarClientServiceIT {
    ...
    public void before() throws Exception {
        ...
        runner.setProperty(service, StandardPulsarClientService.PULSAR_SERVICE_URL, "192.168.0.11:6650");
    ...
    public void testPublishOneMessage() throws Exception {
        ...
        System.out.println(msg.getMessageId().toString());
        assertNotNull(msg);
        assertEquals(MESSAGE, new String(msg.getValue()));
    }

    @Test
    public void testPublish10Messages() throws Exception {
        publishMessages(10);
    }
